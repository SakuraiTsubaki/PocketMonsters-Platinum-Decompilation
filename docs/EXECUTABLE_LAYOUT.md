...
|---|---:|---:|---:|---:|
| ARM9 | `0x4000` | `0x1032F8` (1,061,624) | `0x02000000` | `0x02000800` |
| ARM7 | `0x40A800` | `0x277FC` (161,788) | `0x02380000` | `0x02380000` |

ARM9 overlays: **122** entries (`0x107400`, table size `0xF40`). ARM7 overlays: **0**.
