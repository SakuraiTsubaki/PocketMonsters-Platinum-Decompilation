...
A complete, target-specific foundation for reproducible research, analysis, tooling, and source reconstruction related to **Pocket Monsters Platinum**.

| Field | Value |
| --- | --- |
| Working target | Pocket Monsters Platinum |
| Platform family | Nintendo DS |
| Series generation | Generation IV |
| Exact build identity | Korea / Korean / `CPUK` / header ROM version 0 |
